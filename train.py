...
from core.dataset import get_segmentation_dataset
from core.models import get_segmentation_model
from core.utils.loss import get_segmentation_loss
from core.utils.distributed import make_data_sampler, make_batch_data_sampler, get_rank, reduce_loss_dict, synchronize
...
def parse_args():
    ...
    parser.add_argument('--model', type=str, default='icnet',
                        choices=['icnet', 'lednet'],
                        help='model name (default: icnet)')
    ...
    parser.add_argument('--save-dir', default='./data/output_models/',
        ...
        for iteration, (images, targets, _) in enumerate(self.train_loader):
            ...
            if iteration % log_per_iters == 0 and save_to_disk:
                logger.info(
                    ...
                    "Iters: {:d}/{:d} || Lr: {:.8f} || Loss: {:.4f} || Cost Time: {} || Estimated Time: {}".format(
