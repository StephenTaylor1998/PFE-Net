...
class ResNetV1b(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, dilated=True, deep_stem=False,
                 zero_init_residual=False, norm_layer=nn.BatchNorm2d, local_rank=None):
...
def get_model_file(name, root='./data/pretrain_models'):
...
def resnet50_v1s(pretrained=False, root='./data/pretrain_models', **kwargs):
...
def resnet101_v1s(pretrained=False, root='./data/pretrain_models', **kwargs):
...
def resnet152_v1s(pretrained=False, root='./data/pretrain_models', **kwargs):
