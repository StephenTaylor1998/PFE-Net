...
import core.models.mobilenet_v3.mobilenet as lib
...
def mobilenet(num_classes=1001,
              ...
              pretrained=False,
              checkpoint_path='./pretrained_models/mobilenet_v3_small.pth',
              **kwargs):
...
large_minimalistic = wrapped_partial(mobilenet,
                                     new_defaults={'model_name': 'large_minimalistic'},
                                     conv_defs=V3_LARGE_MINIMALISTIC)
small_minimalistic = wrapped_partial(mobilenet,
                                     new_defaults={'model_name': 'small_minimalistic'},
